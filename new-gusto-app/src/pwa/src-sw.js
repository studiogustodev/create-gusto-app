 ...
 */
// registerRoute(
//   ({ url }) => url.pathname.startsWith('/api/wp-json/'),
//   new StaleWhileRevalidate({
//     cacheName: 'rest-api-response',
//     plugins: [
//       new CacheableResponsePlugin({
//         statuses: [0, 200],
//       }),
...
//  */
// registerRoute(
//   ({ request }) => request.origin === self.location.origin && (request.pathname.endsWith('.png') || request.pathname.endsWith('.jpg')),
//   new CacheFirst({
//     cacheName: 'images',
//     plugins: [
//       new CacheableResponsePlugin({
